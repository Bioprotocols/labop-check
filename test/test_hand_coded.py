...
from labop_check.constraints import (
...
def test_ludox_check_direct():
    ...
    timepoint_vars = {
        t: pysmt.shortcuts.Symbol(t, pysmt.shortcuts.REAL) for t in timepoints
    }

    timepoint_var_domains = [
        pysmt.shortcuts.And(
            pysmt.shortcuts.GE(t, pysmt.shortcuts.Real(0.0)),
    ...
    time_constraints = [
        binary_temporal_constraint(
            timepoint_vars["t_0"], [[0, 0]], timepoint_vars["t_F"]
        ),
        binary_temporal_constraint(
            timepoint_vars["t_F"], [[0, t_inf]], timepoint_vars["t_P1_s"]
        ),
        binary_temporal_constraint(
            timepoint_vars["t_F"], [[0, t_inf]], timepoint_vars["t_P2_s"]
        ),
        binary_temporal_constraint(
            timepoint_vars["t_P1_s"],
            [[t_epsilon, t_inf]],
            timepoint_vars["t_P1_e"],
        ),
        binary_temporal_constraint(
            timepoint_vars["t_P2_s"],
            [[t_epsilon, t_inf]],
            timepoint_vars["t_P2_e"],
        ),
        binary_temporal_constraint(
            timepoint_vars["t_P1_e"], [[0, t_inf]], timepoint_vars["t_M"]
        ),
        binary_temporal_constraint(
            timepoint_vars["t_P2_e"], [[0, t_inf]], timepoint_vars["t_M"]
        ),
        binary_temporal_constraint(
            timepoint_vars["t_M"],
            [[t_epsilon, t_inf]],
            timepoint_vars["t_MA_s"],
        ),
        binary_temporal_constraint(
            timepoint_vars["t_MA_s"],
            [[t_epsilon, t_inf]],
            timepoint_vars["t_MA_e"],
        ),
        binary_temporal_constraint(
            timepoint_vars["t_MA_e"], [[0, 0]], timepoint_vars["t_N"]
        ),
    ]
    ...
    join_constraints = [
        join_constraint(
            timepoint_vars["t_M"],
            [timepoint_vars["t_P2_e"], timepoint_vars["t_P1_e"]],
        )
    ]

    durations = [
        binary_temporal_constraint(
            timepoint_vars["t_P1_s"], [[3, 3]], timepoint_vars["t_P1_e"]
        ),
        binary_temporal_constraint(
            timepoint_vars["t_P2_s"], [[3, 3]], timepoint_vars["t_P2_e"]
        ),
        binary_temporal_constraint(
            timepoint_vars["t_MA_s"], [[10, 10]], timepoint_vars["t_MA_e"]
        ),
        binary_temporal_constraint(
            timepoint_vars["t_0"], [[0, 100]], timepoint_vars["t_N"]
        ),
    ]
...
def test_decision_merge():
    ...
    timepoints = ["decision", "act1", "act2", "merge"]
    t_inf = 10000.0
    t_epsilon = 0.0001
    ...
    timepoint_happens = {
        t: pysmt.shortcuts.Symbol(f"happens({t})") for t in timepoints
    }
    ...
    happens_constraints = [
        ...
        pysmt.shortcuts.Implies(
            timepoint_happens["act1"],
            pysmt.shortcuts.And(timepoint_happens["decision"], condition),
        ),
        pysmt.shortcuts.Implies(
            timepoint_happens["act2"],
            pysmt.shortcuts.And(
                timepoint_happens["decision"], pysmt.shortcuts.Not(condition)
            ),
        ),
        pysmt.shortcuts.Implies(
            timepoint_happens["merge"],
            pysmt.shortcuts.Or(
                timepoint_happens["act1"], timepoint_happens["act2"]
            ),
        ),
    ]
